...
#           lower of 鈭�22 kHz and the Nyquist frequency (for treble).  Its
...
#  led by Goran Soderlund and Sverker Sikstr枚m of Stockholm University, looked at
...
#  G枚ran BW S枚derlund1, Sverker Sikstr枚m, Jan M Loftesnes and EJ Sonuga-Barke
